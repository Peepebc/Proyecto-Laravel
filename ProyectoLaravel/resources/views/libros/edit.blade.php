            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action={{route('libros.update',['libro'=>$libro->id]) }} enctype="multipart/form-data">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input value="{{$libro->autor}}" type="text" name="autor" id="autor"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            <label for="autor"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input value="{{$libro->anio}}" type="text" name="anio" id="anio"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            <label for="anio"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input value="{{$libro->descripcion}}" type="text" name="descripcion" id="descripcion"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <label for="imagen"
                                ...
                                <img src="{{asset($url.$libro->imagen)}}" width="10%">
                        </div>
                        <button type="submit"
